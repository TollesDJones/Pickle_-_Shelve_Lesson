...
# handle multiple exception types with Generic error
print()
for value in (None, "Hi!"):
    try:
        ...
        print("Something went wrong!")
#
# # handle multiple exception types with unique errors
# print()
# for value in (None, "Hi!"):
#     try:
#         print("Attempting to convert", value, "-->", end=" ")
...
# except ValueError:
#     print("That was not a number!")
# else:  # else block executed only if no exception is raised
